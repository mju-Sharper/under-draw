...
import ElectronicIcon from '../assets/ElectronicIcon.svg';
...
export const categoryItemList = [
  ...
  { id: 'jewel', name: 'JEWEL', icon: JewelleryIcon },
...
export const PERCENT_ARRAY = ['1%', '3%', '5%', '10%'];
export const CONTROL_ARRAY = ['START', 'NEXT', 'STOP', 'RESET'];
